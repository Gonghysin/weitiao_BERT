...
def main():
    # 加载标签映射
    with open('/root/weitiao_BERT--/IMCS-DAC_train.json', 'r', encoding='utf-8') as f:
    ...
    # 加载测试数据
    with open('/root/weitiao_BERT--/IMCS-DAC_test.json', 'r', encoding='utf-8') as f:
    ...
    # 保存更新后的测试数据
    output_file = '/root/weitiao_BERT--/output.json'
